...
export const allOrders = asynchandler(async(req,res,next)=>{
    ...
    return res.status(200).json(new ApiResponse(200 ,{ orders, totalammount},"order fetched successfully"))
...
export const deleteOrder = asynchandler(async(req,res,next)=>{
    ...
    if(order.orderStatus!=="Delivered"){
        return next (new ApiError(400, "This order is under processing, order cant be deleted"))
    }
